...
if (!serviceRoleKey) {
  ...
  console.log('  1. Go to https://supabase.com/dashboard/project/ggzhtpaxnhwcilomswtm/settings/api');
...
async function applyMigration() {
  try {
    ...
    console.error('  1. Go to https://supabase.com/dashboard/project/ggzhtpaxnhwcilomswtm/sql/new');
