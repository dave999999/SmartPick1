        ...
        <aside className="lg:col-span-1 no-print hidden lg:block">
          <div className="sticky top-4 bg-white rounded-xl shadow-lg p-4 md:p-6 border border-gray-200">
            ...
            <nav className="space-y-1 text-sm max-h-[70vh] overflow-y-auto">
              <button onClick={() => scrollToSection('faq')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                📋 FAQ
              </button>
              <button onClick={() => scrollToSection('introduction')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                1. Introduction
              </button>
              <button onClick={() => scrollToSection('service')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                2. Service Description
              </button>
              <button onClick={() => scrollToSection('smartpoints')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                3. SmartPoints & Payments
              </button>
              <button onClick={() => scrollToSection('accounts')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                4. User Accounts
              </button>
              <button onClick={() => scrollToSection('eligibility')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                5. Eligibility & Alcohol
              </button>
              <button onClick={() => scrollToSection('partners')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                6. Partner Responsibilities
              </button>
              <button onClick={() => scrollToSection('cancellations')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                7. Cancellations & Refunds
              </button>
              <button onClick={() => scrollToSection('acceptable-use')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                8. Acceptable Use
              </button>
              <button onClick={() => scrollToSection('ip')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                9. Intellectual Property
              </button>
              <button onClick={() => scrollToSection('liability')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                10. Liability & Disclaimers
              </button>
              <button onClick={() => scrollToSection('changes')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                11. Changes to Terms
              </button>
              <button onClick={() => scrollToSection('governing-law')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                12. Governing Law
              </button>
              <button onClick={() => scrollToSection('contact')} className="block w-full text-left px-3 py-2 rounded hover:bg-teal-50 text-gray-700 hover:text-teal-700 transition-colors">
                13. Contact
              </button>
            </nav>
        ...
        <article className="lg:col-span-3 bg-white rounded-xl shadow-lg p-4 md:p-6 lg:p-8 border border-gray-200">
          ...
          <TooltipProvider>
            ...
            <section id="acceptable-use" className="mb-8 scroll-mt-4 print-break-inside-avoid">
              ...
              <p className="text-gray-700 mb-4">When using SmartPick, you agree that you will not:</p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
