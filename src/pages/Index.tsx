...
export default function Index() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-gray-50 overflow-x-hidden p-0 m-0">
        ...
        <section className="w-full relative z-0 p-0 m-0">
          {isLoading ? (
