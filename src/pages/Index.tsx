        ...
        <div className="absolute inset-0 w-full h-full">
          {isLoading ? (
            ...
            <>
              ...
              {/* Empty State */}
              {filteredOffers.length === 0 && (
                <div className="absolute bottom-0 left-0 right-0 h-[45%] bg-white rounded-t-[24px] shadow-[0_-4px_20px_rgba(0,0,0,0.1)] z-20 flex items-center justify-center pointer-events-none">
                  <p className="text-gray-500 pointer-events-none">No offers available</p>
                </div>
              )}
