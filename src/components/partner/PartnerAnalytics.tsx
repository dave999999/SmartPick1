  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {/* Completion Rate */}
        <Card className="border-none bg-gradient-to-br from-emerald-50 to-emerald-100/50 shadow-sm hover:shadow-md transition-all">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-emerald-700 uppercase tracking-wide">Success</span>
        ...
        {/* Average Order */}
        <Card className="border-none bg-gradient-to-br from-blue-50 to-blue-100/50 shadow-sm hover:shadow-md transition-all">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-blue-700 uppercase tracking-wide">Avg Order</span>
        ...
        {/* Revenue Trend */}
        <Card className="border-none bg-gradient-to-br from-purple-50 to-purple-100/50 shadow-sm hover:shadow-md transition-all">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-purple-700 uppercase tracking-wide">Trend</span>
              <div className={`w-8 h-8 rounded-lg bg-gradient-to-br flex items-center justify-center ${
                revenueTrend >= 0 ? 'from-green-500 to-green-600' : 'from-red-500 to-red-600'
              }`}>
                {revenueTrend >= 0 ? <TrendingUp className="w-4 h-4 text-white" /> : <TrendingDown className="w-4 h-4 text-white" />}
              </div>
            </div>
        ...
        {/* Cancelled */}
        <Card className="border-none bg-gradient-to-br from-orange-50 to-orange-100/50 shadow-sm hover:shadow-md transition-all">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
      ...
      <Card className="border-none shadow-md">
        <CardContent className="p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">7-Day Revenue</h3>
              <p className="text-xs text-gray-500 mt-0.5">Daily average: ₾{avgRevenue.toFixed(2)}</p>
            </div>
          </div>
        ...
        <Card className="border-none shadow-md">
          <CardContent className="p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">Top Selling</h3>
            </div>
        ...
        <Card className="border-none shadow-md">
          <CardContent className="p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wide">Peak Hours</h3>
            </div>
