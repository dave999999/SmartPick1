          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
                <div>
                  <div className="font-medium text-gray-900">ახალი ჯავშანი</div>
                  <div className="text-sm text-gray-500">შეტყობინება ახალი ჯავშნის შესახებ</div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
                <div>
                  <div className="font-medium text-gray-900">გაუქმებული ჯავშანი</div>
                  <div className="text-sm text-gray-500">შეტყობინება გაუქმების შესახებ</div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
                <div>
                  <div className="font-medium text-gray-900">მიღებული ჯავშანი</div>
                  <div className="text-sm text-gray-500">შეტყობინება როცა მომხმარებელი იღებს შეკვეთას</div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              ...
              <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
                <div>
                  <div className="font-medium text-gray-900">სისტემის შეტყობინებები</div>
                  <div className="text-sm text-gray-500">განახლებები და მნიშვნელოვანი შეტყობინებები</div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              <button
                onClick={() => toast.info('შეტყობინებების პარამეტრები შენახულია')}
