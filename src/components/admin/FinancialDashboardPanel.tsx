...
export default function FinancialDashboardPanel() {
  ...
  return (
    <div className="space-y-6 p-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-xl min-h-screen">
      <div>
        <h2 className="text-2xl font-bold text-white">Financial Dashboard</h2>
        <p className="text-gray-300 mt-1">Platform revenue from point purchases (last 30 days) - Currency: GEL (Georgian Lari)</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card className="bg-white border-gray-200 shadow-lg hover:shadow-xl transition-all">
          <CardHeader className="pb-2">
            <CardTitle className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Total Purchases</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{revenueStats?.total_point_purchases || 0}</div>
            <div className="flex items-center gap-1 text-xs text-gray-500 mt-1"><ShoppingCart className="w-3 h-3" />Transactions</div>
          </CardContent>
        </Card>
        <Card className="bg-white border-gray-200 shadow-lg hover:shadow-xl transition-all">
          <CardHeader className="pb-2">
            <CardTitle className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Points Sold</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white border-gray-200 shadow-lg hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]" onClick={() => setShowBuyerModal(true)}>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              ...
              {dailyRevenue.map((day: DailyRevenueSummary) => (
                <div key={day.revenue_date} className="grid grid-cols-5 gap-4 py-2 text-sm hover:bg-gray-50 rounded">
