...
import { CircleUser, Globe, LogIn, LogOut, User, Star, Heart, PanelsTopLeft, ShieldCheck, Languages } from 'lucide-react';
      ...
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        <DropdownMenuTrigger asChild>
          <Button
            size="icon"
            variant="secondary"
            className="rounded-full shadow-sm bg-white/90 backdrop-blur border"
            aria-label="Account menu"
          >
            <CircleUser className="h-5 w-5 text-gray-700" />
          </Button>
        </DropdownMenuTrigger>
