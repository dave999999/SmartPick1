...
export const PERMISSIONS = {
  ...
  'partners:ban': [AdminRole.OPS_ADMIN, AdminRole.SUPER_ADMIN],
  'partners:unban': [AdminRole.OPS_ADMIN, AdminRole.SUPER_ADMIN],
  ...
  'offers:edit': [AdminRole.OPS_ADMIN, AdminRole.PARTNER_ADMIN, AdminRole.SUPER_ADMIN],
  'offers:pause': [AdminRole.OPS_ADMIN, AdminRole.SUPER_ADMIN],
  'offers:unpause': [AdminRole.OPS_ADMIN, AdminRole.SUPER_ADMIN],
  'offers:extend': [AdminRole.OPS_ADMIN, AdminRole.SUPER_ADMIN],
  'offers:emergency_pause': [AdminRole.SUPER_ADMIN],
