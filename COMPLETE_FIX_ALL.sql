-- ================================================
-- COMPLETE FIX: Approve Partners + Create Achievements
-- ================================================
-- Run this ONE script to fix both issues at once

BEGIN;

-- ==============================================
-- PART 1: APPROVE ALL PARTNERS (Critical for offer creation)
-- ==============================================
...
SELECT 
  ...
  status,
  user_id,
  'Partner approved - can now create offers!' as message
...
-- ==============================================
-- PART 3: CREATE 50 ACHIEVEMENTS (Correct Schema)
-- ==============================================
...
-- Check achievements created
SELECT COUNT(*) || ' achievements created' AS achievement_status 
FROM public.achievement_definitions WHERE is_active = true;
...
SELECT 
  ...
  status,
  CASE 
    WHEN status = 'APPROVED' THEN '✅ Can create offers'
    ELSE '❌ Cannot create offers - needs approval'
  END as offer_creation_status
FROM public.partners;

-- Final success message
SELECT '✅ COMPLETE: Partners approved + 50 achievements created!' AS final_status;
