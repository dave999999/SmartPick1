-- APPLY THIS DIRECTLY TO SUPABASE DATABASE
-- Fix expired offers showing in viewport and reservation pages

-- Update the viewport function to also check pickup_end
...
BEGIN
  ...
  WHERE 
    ...
    AND (o.pickup_end IS NULL OR o.pickup_end > NOW())  -- ✅ CRITICAL FIX: Filter expired pickup windows
...
-- Add comment
COMMENT ON FUNCTION get_offers_in_viewport IS 'Get active offers within map viewport bounds with partner details - filters expired offers and pickup windows';
