-- =====================================================
-- Admin Communication System - Database Schema
-- =====================================================
-- This creates tables for announcements and messaging
...
CREATE INDEX IF NOT EXISTS idx_direct_messages_recipient ON direct_messages(recipient_id, recipient_type);
...
DROP POLICY IF EXISTS partners_read_announcements ON announcements;
DROP POLICY IF EXISTS users_announcement_reads ON announcement_reads;
DROP POLICY IF EXISTS admin_announcement_reads ON announcement_reads;
DROP POLICY IF EXISTS read_own_messages ON direct_messages;
DROP POLICY IF EXISTS admin_direct_messages ON direct_messages;
