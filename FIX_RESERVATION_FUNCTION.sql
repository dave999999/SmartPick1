-- Fix create_reservation_atomic to support both user_points and partner_points
-- This function needs to check if user is a partner and use the correct table
...
-- Now try making a reservation through the app.
