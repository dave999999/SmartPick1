-- ============================================
-- TEST 2ND WARNING - EXPIRE ACTIVE RESERVATION
-- ============================================
-- User: batumashvili.davit@gmail.com
-- Current state: 1 warning, 1 active reservation
-- Action: Mark reservation as FAILED_PICKUP and apply 2nd warning
-- ============================================
...
-- Step 2: Update user penalty count (1 → 2)
UPDATE users
SET 
  penalty_count = 2,
...
-- Step 3: Insert 2nd warning penalty
WITH user_data AS (
...
SELECT 
  ...
  2,  -- 2nd offense
  'missed_pickup',
  'warning',  -- Still a warning, not suspension yet
  NULL,  -- No suspension for warnings
  true,  -- Active
...
-- ============================================
-- 2nd warning applied! ✅
-- Refresh app to see the 2nd warning popup 🔔
-- Still have 1 more free warning before suspension! ⚠️
-- ============================================
