-- Fix expired offers showing in viewport
-- Add pickup_end validation to prevent showing offers with expired pickup windows
...
BEGIN
  ...
  WHERE 
    ...
    AND (o.pickup_end IS NULL OR o.pickup_end > NOW())  -- ✅ NEW: Filter expired pickup windows
