-- =====================================================
-- Admin Alert System - Database Schema
-- =====================================================
-- This creates tables for automated alerts and rules
...
DROP POLICY IF EXISTS admin_alert_rules_all ON alert_rules;
...
DROP POLICY IF EXISTS admin_alert_events_all ON alert_events;
...
DROP POLICY IF EXISTS admin_system_alerts_all ON system_alerts;
